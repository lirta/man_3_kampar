...
class DaftarMapelKalenderSiswa extends StatefulWidget {
  const DaftarMapelKalenderSiswa({ Key key }) : super(key: key);

  @override
  _DaftarMapelKalenderSiswaState createState() => _DaftarMapelKalenderSiswaState();
}

class _DaftarMapelKalenderSiswaState extends State<DaftarMapelKalenderSiswa> {
  @override
