...
class DaftarAjaranKalenderPage extends StatefulWidget {
  const DaftarAjaranKalenderPage({Key key}) : super(key: key);

  @override
  _DaftarAjaranKalenderPageState createState() =>
      _DaftarAjaranKalenderPageState();
}

class _DaftarAjaranKalenderPageState extends State<DaftarAjaranKalenderPage> {
  ProgressDialog pr;
  @override
        ...
        child: ajaranProvider.ajaran == null
            ...
            : Column(
                children: ajaranProvider.ajaran
                    .map((ajaran) => AjaranKalender(ajaran))
                    .toList(),
              ),
      );
    }
