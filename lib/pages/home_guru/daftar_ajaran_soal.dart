...
class DaftarAjaranSoalPage extends StatefulWidget {
  const DaftarAjaranSoalPage({Key key}) : super(key: key);

  @override
  _DaftarAjaranSoalPageState createState() => _DaftarAjaranSoalPageState();
}

class _DaftarAjaranSoalPageState extends State<DaftarAjaranSoalPage> {
  ProgressDialog pr;
  @override
